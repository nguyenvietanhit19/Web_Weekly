...
namespace DataAccess.Controllers
{
    ...
    {
        private readonly ShoppingCartDbFirstContext _context;

        public SanPhamsController(ShoppingCartDbFirstContext context)
        {
            _context = context;
        }
        ...
        {
            var shoppingCartDbFirstContext = _context.SanPhams.Include(s => s.MaLoaiNavigation);
            return View(await shoppingCartDbFirstContext.ToListAsync());
        }
